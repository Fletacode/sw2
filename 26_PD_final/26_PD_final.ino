...
// Target Distance
#define _DIST_TARGET    255 // Center of the rail (unit:mm)

// PID parameters
#define _KP 8  // proportional gain
...
float volt_to_distance(int a_value)
{
  ...
  //return 714 + (-2.39*a_value) + (2.03E-03 * pow(a_value,2));
  //return 644 + (-2.26*a_value) + (2.02E-03 * pow(a_value,2)); //- 30
  //return 787 + (-2.5*a_value) + (2.02E-03 * pow(a_value,2)); +30
  
  //return 594 + (-2.14*a_value) + (1.96E-03 * pow(a_value,2)); //-50
  //return 626 + (-2.2 * a_value) + (1.96E-03 * pow(a_value,2)); //-35
  return 611 + (-2.17 * a_value) + (1.96E-03 * pow(a_value,2)); //- 42
  //return ???;
}
