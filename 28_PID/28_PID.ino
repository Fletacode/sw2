...
float _KP = 7;   // proportional gain
float _KD = 140;   // derivative gain
...
////////////////////////////////////////////////////////////////////////
  ...
  if (event_serial) {
    ...
    if (MODE == 1) { // use for debugging with serial monitor
      ...
      Serial.print("TIEM: "); Serial.print(time_current);
      Serial.print("KP: "); Serial.print(_KP);
...
float volt_to_distance(int a_value)
{
  ...
  //return 940 + (-5.48*a_value) + (0.0117* pow(a_value,2)) + (-8.7E-06 * pow(a_value,3));
